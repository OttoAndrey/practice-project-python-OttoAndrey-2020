...
Проект, выполненный на летней практике 2020 от компании SibDev.

Проект представляет веб-приложение заведений, с владельцами, блюдами и ингредиентами.
Была разработана авторизация пользователя с помощью DRF. Созданы модели для приложения (заведения, блюда, ингредиенты). Часть данных была спарсена со стороннего сайта. Для управления моделями были использованы пермишены. Для проекта была составлена документация с помощью сваггера. Написаны тесты при создании моделей. Подключено кеширование через Redis. Настроен веб-сервер nginx.
